...
7 sensors to display info such as volume, video format, audio format etc. are also created, enabling you to show the type of info you see on the processors from screen.
